class ProductAreasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_area.save
        ...
        format.json { render :show, status: :created, location: @product_area }
      else
  ...
  def update
    respond_to do |format|
      if @product_area.update(product_area_params)
        ...
        format.json { render :show, status: :ok, location: @product_area }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to product_areas_url, notice: 'Product area was successfully destroyed.' }
